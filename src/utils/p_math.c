...
#define P_MATH_DECLARE_V2_FUNCS(__tsuf, __type)\
    ...
    f32 pDist_v2##__tsuf(_pVec2##__tsuf __vector1, _pVec2##__tsuf __vector2) { return sqrtf(powf((f32)__vector2.x - (f32)__vector1.x, 2.f) + powf((f32)__vector2.y - (f32)__vector1.y, 2.f)); }\
...
#define P_MATH_DECLARE_V3_FUNCS(__tsuf, __type)\
    ...
    f32 pDist_v3##__tsuf(_pVec3##__tsuf __vector1, _pVec3##__tsuf __vector2) { return sqrtf(powf((f32)__vector2.x - (f32)__vector1.x, 2.f) + powf((f32)__vector2.y - (f32)__vector1.y, 2.f) +  + powf((f32)__vector2.z - (f32)__vector1.z, 2.f)); }\
